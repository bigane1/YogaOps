...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/yoga-femmes`, changeFrequency: "weekly", priority: 0.95 },
    {
    ...
    { url: `${baseUrl}/compte`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/compte/cartes`, changeFrequency: "monthly", priority: 0.7 },
